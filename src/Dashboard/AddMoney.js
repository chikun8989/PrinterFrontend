...
//         <Typography variant="h6" color="error" gutterBottom>Note :</Typography>
//         <Typography variant="body1">1. आपके अकाउंट में बैलेंस डालने का कार्य केवल सुबह 10 से शाम 7 बजे तक ही किया जायेगा !</Typography>
//         <Typography variant="body1">2. पेमेंट ट्रांसफर करने के बाद id नंबर, फर्म का नाम एवं स्क्रीनशॉट इस (7849972351) नंबर पर व्हाट्सअप कर दें (इस नंबर पर कॉलिंग एक्टिव नहीं है)!</Typography>
//         <Typography variant="body1">3. रविवार अथवा अवकाश के दिन बैलेंस एड नहीं किया जायेगा!!!</Typography>
//         <Box mt={4}>
//           <Button variant="outlined">TO ADD MONEY IN YOUR WALLET</Button>
//         </Box>
//         <Box mt={4}>
//           <img src="path-to-your-qr-code-image" alt="QR Code" />
//           <Typography variant="body1">
//             PRINTERS EYE PRIVATE LIMITED
//             <br />
//             A/C NUMBER : 361605000947
//             <br />
//             IFSC : ICIC0003616
//             <br />
//             BRANCH :- SIRSI ROAD, JAIPUR.
//           </Typography>
//         </Box>
//       </Container>
//     </ThemeProvider>
...
//          <Typography variant="body1">2. पेमेंट ट्रांसफर करने के बाद id नंबर, फर्म का नाम एवं स्क्रीनशॉट इस (7849972351) नंबर पर व्हाट्सअप कर दें (इस नंबर पर कॉलिंग एक्टिव नहीं है)!</Typography>
//          <Typography variant="body1">3. रविवार अथवा अवकाश के दिन बैलेंस एड नहीं किया जायेगा!!!</Typography>
//          <Box mt={4}component="section" height={50} width={300}display="flex" alignItems="center"sx={{ p: 2, border: '1px dashed grey' }}>
