    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      <Box display="flex" justifyContent="center" alignItems="center">            
                ...
                <TableContainer component={Paper} sx={{width:350}}>
                    ...
                    <TableBody>
                    <TableRow>
                        <TableCell sx={{  color: 'black' }}>6.36</TableCell>
                        <TableCell sx={{ color: 'red' }}>0.00</TableCell>
                        <TableCell sx={{  color: 'green' }}>0.00</TableCell>
                        <TableCell sx={{  color: 'black' }}>6.36</TableCell>
      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell sx={{ backgroundColor: 'lightblue', color: 'black' }}>INV NO</TableCell>
              <TableCell sx={{ backgroundColor: 'lightblue', color: 'black' }}>DATE</TableCell>
              <TableCell sx={{ backgroundColor: 'lightblue', color: 'black' }}>OPENING</TableCell>
              ...
              <TableCell sx={{ backgroundColor: 'lightblue', color: 'black' }}>REMARKS</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
